...
export default function Hero() {
  return (
    <section style={{ position: 'relative', height: '82vh', minHeight: 560, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 48, bottom: 56, color: 'var(--bone)', maxWidth: 640 }}>
        <div style={{ fontSize: 11, letterSpacing: '0.14em', textTransform: 'uppercase', opacity: 0.8, marginBottom: 18, fontWeight: 500 }}>
          The Slip Edit · SS26
        </div>
        <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(44px, 6vw, 88px)', lineHeight: 1.02, letterSpacing: '-0.01em', margin: 0, fontWeight: 400 }}>
