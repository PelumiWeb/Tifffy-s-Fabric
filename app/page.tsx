  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', height: 520, margin: '0 32px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', left: 48, top: '50%', transform: 'translateY(-50%)', color: 'var(--bone)', maxWidth: 480 }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: 52, lineHeight: 1.05, letterSpacing: '-0.01em', margin: 0, fontWeight: 400 }}>Dressed for a long night.</h2>
